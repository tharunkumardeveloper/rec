...
output_folder = r"C:\Users\Tharun\OneDrive\Desktop\TALENT KIRO\server\outputs\live_1760058946291_Push_ups"
...
frame_count += 1
    ...
    # cv2.imshow removed for headless execution
    out_vid.write(frame)

    if # cv2.waitKey removed for headless execution & 0xFF in [27, ord('q')]:  # ESC/Q to exit
        break
